...
const PROTECTED_HANDLES = new Set([
  ...
  'philhchen', 'culperresearch', 'weixin_wechat'
]);
...
async function main() {
  console.log('=== 开始第二批安全清理（目标：再清理 35 个，将关注数降至 ~428）===');

  let unfollowedCount = 0;
  const targetBatch = 35;
  ...
  console.log(`\n🎉 第二批清理完成！本次成功取关 ${unfollowedCount} 个。`);
}
