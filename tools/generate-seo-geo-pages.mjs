...
const servicePages = [
  ...
  },
  {
    ...
    lang: "en",
    breadcrumb: "Custom Trading Software for Teams",
    eyebrow: "For Strategy Owners and Trading Teams",
    title: "Custom Trading Software for Teams | Execution, Risk Controls and Private Deployment",
    description: "Build custom trading software around documented execution rules, existing signals and team workflows, with source code, risk controls and private deployment.",
    h1: "Build Trading Software Around Your Existing Workflow",
    intro: "For strategy owners and trading teams that already know how the workflow should operate but need dependable software to replace manual steps, disconnected tools or fragile scripts.",
    serviceType: "Custom trading software for strategy owners and trading teams",
    llmsLabel: "Custom Trading Software for Teams",
    buyerIntentVersion: 1,
